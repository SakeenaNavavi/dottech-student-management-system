...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Example: const response = await fetch('/api/student/login', {
      //   method: 'POST',
        ...
        <div className="max-w-md w-full space-y-8 bg-black p-8 rounded-lg shadow-lg">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-400">
              Access your academic profile and term marks
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/student/register" className="font-medium text-red-500 hover:text-red-400">
                Register now
              </Link>
            </p>
          </div>
